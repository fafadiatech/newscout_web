...
url_router.register(r"categories", CategoryModelViewSet, basename="category")
...
urlpatterns = [
    ...
    url(r"^source/$", SourceModelViewSet.as_view({'get': 'list'}), name="source-list"),
    url(r"^domains/$", DomainsModelViewSet.as_view({'get': 'list'}), name="domains-list"),
    url(r"^users/$", UsersModelViewSet.as_view({'get': 'list'}), name="users-list"),
